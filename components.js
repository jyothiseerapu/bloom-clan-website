...
function Footer() {
  return `<footer class="site-footer"><div class="container"><div><strong>Bloom Clan</strong><div class="small">Handmade keepsakes, cards, and gifting moments with calm elegance.</div></div><div class="small">© ${new Date().getFullYear()} Bloom Clan</div></div></footer>`;
}
